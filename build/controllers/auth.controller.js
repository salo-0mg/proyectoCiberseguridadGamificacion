...
var signUp = exports.signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, lastname, email, birthDate, password, roles, encryptedPassword, newUser, foundRoles, role, savedUser, newScore, savedScore, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, name = _req$body.name, lastname = _req$body.lastname, email = _req$body.email, birthDate = _req$body.birthDate, password = _req$body.password, roles = _req$body.roles;
          _context.next = 4;
        ...
        case 30:
          ...
          console.error('Error durante el registro:', _context.t0);
          res.status(500).json({
