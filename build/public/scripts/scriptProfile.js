  ...
  function loadUser() {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState === 4 && this.status === 200) {
        ...
        var max_score_spam = document.getElementById("max_score_spam");
        var avg_score_spam = document.getElementById("avg_score_spam");
        var count_scores_spam = document.getElementById("count_scores_spam");
        var max_score_phishing = document.getElementById("max_score_phishing");
        var avg_score_phishing = document.getElementById("avg_score_phishing");
        var count_scores_phishing = document.getElementById("count_scores_phishing");
  ...
  function drawChartSpam(scoresSpam) {
    ...
    google.charts.setOnLoadCallback(function () {
      ...
      scoresSpam.forEach(function (score, index) {
        data.addRow(["Intento ".concat(index + 1), score]); // Index + 1 para mostrar el intento comenzando desde 1
      });
