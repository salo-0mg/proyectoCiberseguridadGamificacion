...
const awarenessMessages = [
    "¡Cuidado! Los mensajes de spam suelen pedir información personal o financiera.",
    "No abras enlaces de remitentes desconocidos. Podrían ser phishing.",
    "No respondas a correos que te prometen grandes sumas de dinero sin razón aparente.",
    "Desconfía de los correos que piden urgencia o presionan a tomar acciones rápidas.",
    "Los mensajes de spam pueden contener errores ortográficos o gramaticales evidentes."
];
/**************
OBJETOS
**************/
...
const gameOver=()=>{
	const randomMessage = getRandomMessage(awarenessMessages);
	limpiarCanvas();
